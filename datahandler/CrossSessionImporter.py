...
class CrossSessionImporter(object):

    def __init__(self):
        #Import super class

        #self.seperated_subjects
        pass

    def get_intra_session_for_sid(self, sid):
        pass
        #get pretrain dataset

        #load from cross-subject then apply rest of data
        #this could however influence the results, as it is biased to the last given data...

        #must reimport stuff, as we don't have labels anymore

    def get_pretrain_for_sid(self):
        pass

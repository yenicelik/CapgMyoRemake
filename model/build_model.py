...
def init_graph():
    ...
    W = {
        ...
        "W_Conv2": tf.get_variable("W_Conv2", shape=[3, 3, 64, 64], dtype=tf.float32,
                initializer=tf.random_normal_initializer(mean=0.00, stddev=0.01),
        ),
        ...
        #         initializer=tf.random_normal_initializer(mean=0.00, stddev=0.01),
        # ),
        "W_Affine1": tf.get_variable("W_Affine1", shape=[16 * 8 * 64, 512], dtype=tf.float32,
                initializer=tf.random_normal_initializer(mean=0.00, stddev=0.01),
        ),
        "W_Affine2": tf.get_variable("W_Affine2", shape=[512, 512], dtype=tf.float32,
                initializer=tf.random_normal_initializer(mean=0.00, stddev=0.01),
        ),
        "W_Affine3": tf.get_variable("W_Affine3", shape=[512, 128], dtype=tf.float32,
                initializer=tf.random_normal_initializer(mean=0.00, stddev=0.01),
        ),
        "W_Affine4": tf.get_variable("W_Affine4", shape=[128, 10], dtype=tf.float32,
                initializer=tf.random_normal_initializer(mean=0.00, stddev=0.01),
        )
    }

    b = {
        "b_Conv1": tf.get_variable("b_Conv1", shape=[1, 16, 8, 64], dtype=tf.float32,
                initializer=tf.random_normal_initializer(mean=0.00, stddev=0.01),
        ),
        "b_Conv2": tf.get_variable("b_Conv2", shape=[1, 16, 8, 64], dtype=tf.float32,
                initializer=tf.random_normal_initializer(mean=0.00, stddev=0.01),
        ),
        ...
        #         initializer=tf.random_normal_initializer(mean=0.00, stddev=0.01),
        # ),
        "b_Affine1": tf.get_variable("b_Affine1", shape=[1, 512], dtype=tf.float32,
                initializer=tf.random_normal_initializer(mean=0.00, stddev=0.01),
        ),
        "b_Affine2": tf.get_variable("b_Affine2", shape=[1, 512], dtype=tf.float32,
                initializer=tf.random_normal_initializer(mean=0.00, stddev=0.01),
        ),
        "b_Affine3": tf.get_variable("b_Affine3", shape=[1, 128], dtype=tf.float32,
                initializer=tf.random_normal_initializer(mean=0.00, stddev=0.01),
        ),
        "b_Affine4": tf.get_variable("b_Affine4", shape=[1, 10], dtype=tf.float32,
                initializer=tf.random_normal_initializer(mean=0.00, stddev=0.01),
        )
    }
